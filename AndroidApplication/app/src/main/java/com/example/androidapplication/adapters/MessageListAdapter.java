...
import com.example.androidapplication.Utils.Utils;
...
public class MessageListAdapter extends RecyclerView.Adapter  {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == View_right) {
            ...
            View itemView = mInflater.inflate(R.layout.received_message, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (messages != null) {
            ...
            switch (holder.getItemViewType()) {
                case View_left:
                    ((ReceivedMessageViewHolder) holder).bind(current, position);
                    break;
                case View_right:
                    ((SentMessageViewHolder) holder).bind(current, position);
            }
        }
    }
    ...
    class SentMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        private SentMessageViewHolder(View itemView) {
            super(itemView);
...
//            dateText.setText(formattedDate);
    ...
    class ReceivedMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        private ReceivedMessageViewHolder(View itemView) {
            super(itemView);
