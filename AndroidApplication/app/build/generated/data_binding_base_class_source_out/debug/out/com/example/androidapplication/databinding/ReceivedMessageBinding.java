...
public final class ReceivedMessageBinding implements ViewBinding {
  @NonNull
  ...
  private ReceivedMessageBinding(@NonNull ConstraintLayout rootView,
  ...
  public static ReceivedMessageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.received_message, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ReceivedMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ReceivedMessageBinding((ConstraintLayout) rootView, cardGchatMessageOther,
