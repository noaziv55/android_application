...
public final class ActivityLoginPageBinding implements ViewBinding {
  ...
  @NonNull
  public final Button registerLinkBtn;
  ...
  private ActivityLoginPageBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      ...
      @NonNull ImageView imageView, @NonNull Button registerLinkBtn) {
    this.rootView = rootView;
    this.btnLogin = btnLogin;
    this.editTextTextPassword = editTextTextPassword;
    this.editTextTextPersonName = editTextTextPersonName;
    this.imageView = imageView;
    this.registerLinkBtn = registerLinkBtn;
  }
  ...
  public static ActivityLoginPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.register_link_btn;
      Button registerLinkBtn = ViewBindings.findChildViewById(rootView, id);
      if (registerLinkBtn == null) {
        break missingId;
      }

      return new ActivityLoginPageBinding((ConstraintLayout) rootView, btnLogin,
          editTextTextPassword, editTextTextPersonName, imageView, registerLinkBtn);
    }
