...
public final class ActivityMainPageBinding implements ViewBinding {
  ...
  private ActivityMainPageBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton btnAdd, @NonNull ImageButton btnSetting,
      @NonNull RecyclerView listView, @NonNull TextView mainPageTitle,
  ...
  public static ActivityMainPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainPageBinding((ConstraintLayout) rootView, btnAdd, btnSetting, listView,
          mainPageTitle, refreshLayout);
    }
